...
class SignUpButton2: NSButton {
    ...
    override func drawRect(dirtyRect: NSRect) {
        ...
        self.attributedTitle = NSAttributedString(string: "Sign Up", attributes: [ NSForegroundColorAttributeName : NSColor.whiteColor(), NSParagraphStyleAttributeName : style, NSFontAttributeName: font])
